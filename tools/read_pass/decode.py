...
def _build_prompt(symbol: str, op: Operator, context: str = "") -> str:
    ...
    return (
        ...
        "really points to — never the literal/historical surface.\n\n"
...
def decode(symbol: str, operator: Operator, context: str = "",
    ...
    # PATH 2 — novel: run the act via the model, grounded in the doctrine.
    ...
    try:
        raw = operator.caller(_build_prompt(sym, operator, context))
    ...
    return _envelope(True, {
        ...
        "source": "generated",
    }, {"path": "generate", "learned": bool(learn)}, [])
